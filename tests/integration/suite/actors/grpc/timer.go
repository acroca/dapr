...
func (tm *timer) Setup(t *testing.T) []framework.Option {
	srv := procgrpcapp.New(t,
		...
		procgrpcapp.WithOnActorTimerFn(func(_ context.Context, r *rtv1.OnActorTimerRequest) (*rtv1.OnActorReminderResponse, error) {
			tm.mu.Lock()
			if tm.seen == nil {
				tm.seen = r
			}
	...
	return []framework.Option{
		framework.WithProcesses(tm.sched, tm.place, srv, tm.daprd),
	}
}
