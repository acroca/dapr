...
func (c *contentRoundTrip) Setup(t *testing.T) []framework.Option {
	srv := procgrpcapp.New(t,
		...
		procgrpcapp.WithOnActorInvokeFn(func(_ context.Context, req *rtv1.OnActorInvokeRequest) (*rtv1.OnActorInvokeResponse, error) {
			c.mu.Lock()
	...
	return []framework.Option{
		framework.WithProcesses(c.place, srv, c.daprd),
	}
}
